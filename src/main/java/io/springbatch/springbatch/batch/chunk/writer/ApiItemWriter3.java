...
public class ApiItemWriter3 extends FlatFileItemWriter<ApiRequestVO> {
    ...
    public void write(List<? extends ApiRequestVO> items) throws Exception {
        ...
        super.setResource(new FileSystemResource("/Users/a1101717/Desktop/inflearn/스프링 배치 - Sping Boot 기반으로 개발하는 Spring Batch/spring-batch/src/main/resources/product3.txt"));
